...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
    url = "https://github.com/f-person/git-blame.nvim"
  },
  harpoon = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/ThePrimeagen/harpoon"
  },
  ["iron.nvim"] = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/iron.nvim",
  ...
  playground = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/Users/nico/.local/share/nvim/site/pack/packer/start/undotree",
