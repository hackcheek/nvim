...
if g:mode == 'focus'
  ...
  let g:amora#palette.color_0  = '#ed3f7f'
...
elseif g:mode =='focus_testing'
  ...
  let g:amora#palette.color_2  = '#F7D98D'
  ...
  let g:amora#palette.color_10 = '#F7D98D'
...
elseif g:mode =='kiwi'
  ...
  let g:amora#palette.green     = ['#f9cd7f',  84]
...
call s:h('AmoraCommentBold', s:comment, s:none, [s:attrs.italic])
